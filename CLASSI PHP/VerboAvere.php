...
class VerboAvere extends Verbo {
    ...
    private $desinenza_indicativo_presente = ["ho","hai","ha","abbiamo","avete","hanno"];
    private $desinenza_indicativo_imperfetto = ["avevo","avevi","aveva","avevamo","avevate","avevano"];
    private $desinenza_indicativo_passato_remoto = ["ebbi","avesti","ebbe","avemmo","aveste","ebbero"];
    private $desinenza_indicativo_futuro_semplice = ["avrò","avrai","avrà","avremo","avrete","avranno"];
    private $desinenza_congiuntivo_presente = ["abbia","abbia","abbia","abbiamo","abbiate","abbiano"];
    private $desinenza_congiuntivo_imperfetto = ["avessi","avessi","avesse","avessimo","aveste","avessero"];
    private $desinenza_condizionale_presente = ["avrei","avresti","avrebbe","avremmo","avreste","avrebbero"];
    private $desinenza_imperativo_presente = ["","abbi","abbia","abbiamo","abbiate","abbiano"];
    private $desinenza_participio_presente = "avente/abbiente";
    private $desinenza_participio_passato = "avuto";
    private $desinenza_gerundio_presente = "avendo";
