...
class TerzaConiugazione implements Coniugazione {
    ...
    private $desinenza_indicativo_presente = ["o","i","e","iamo","ite","ono"];
    private $desinenza_indicativo_imperfetto = ["ivo","ivi","iva","ivamo","ivate","ivano"];
    private $desinenza_indicativo_passato_remoto = ["ii","isti","ì","immo","iste","irono"];
    private $desinenza_indicativo_futuro_semplice = ["irò","irai","irà","iremo","irete","iranno"];
    private $desinenza_congiuntivo_presente = ["a","a","a","iamo","iate","ano"];
    private $desinenza_congiuntivo_imperfetto = ["issi","issi","isse","issimo","iste","issero"];
    private $desinenza_condizionale_presente = ["irei","iresti","irebbe","iremmo","ireste","irebbero"];
    private $desinenza_imperativo_presente = ["","i","a","iamo","ite","ano"];
    private $desinenza_participio_presente = "ente";
    private $desinenza_participio_passato = "ito";
    private $desinenza_gerundio_presente = "endo";
/*
    if (desinenza=="ire"){
        // desinenzapi=["o","i","e","iamo","ite","ono"];
        if(incoativo1=="SI") desinenzapi=["isco","isci","isce","iamo","ite","iscono"];
        // desinenzaii=["ivo","ivi","iva","ivamo","ivate","ivano"];
        // desinenzafsi= ["irò","irai","irà","iremo","irete","iranno"];
        // desinenzari= ["ii","isti","ì","immo","iste","irono"];
        desinenza20=[desinenzapi,desinenzaii,desinenzari,desinenzafsi];
        // desinenzapc= ["a","a","a","iamo","iate","ano"];
        if(incoativo1=="SI") desinenzapc= ["isca","isca","isca","iamo","iate","iscano"];
        // desinenzaic= ["issi","issi","isse","issimo","iste","issero"];
        desinenza40=[desinenzapc,desinenzaic];
        // desinenzapco= ["irei","iresti","irebbe","iremmo","ireste","irebbero"];
        // desinenzapim= ["","i","a","iamo","ite","ano"];
        if(incoativo1=="SI") desinenzapim= ["","isci","isca","iamo","ite","iscano"];
        desinenza60=[desinenzapim,desinenzafsi];
        // desinenza71="ito";
        // desinenza72="ente";
        desinenza75="iti";
        // desinenza77="endo";
